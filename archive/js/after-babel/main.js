...
function updatePortrait() {
  ...
  header.addEventListener("click", function(event) {
    ...
    var dataImgAttr = []
      .concat(_toConsumableArray(event.target.attributes))
...
//React Injection
{
  var ProjectCard = function ProjectCard(props) {
    ...
    return React.createElement(
      "a",
      {
        href: project.url,
        target: "_blank",
        className: "card container--flex container--relative content--centered",
        style: { backgroundImage: "url(" + project.imageUrl + ")" },
      },
      React.createElement("h3", { className: "project__title" }, project.title),
      React.createElement(
        "p",
  ...
  var createSRonlyText = function createSRonlyText(str) {
    return React.createElement("span", { className: "sr-only" }, str)
  }
  ...
  var ProjectSection = (function(_React$Component) {
    ...
    function ProjectSection(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (
          ProjectSection.__proto__ || Object.getPrototypeOf(ProjectSection)
        ).call(this, props)
      )

      _this.defaultState = {
        activeTags: new Set(
          props.projects.flatMap(function(project) {
            return project.tags
          })
        ),
    ...
    _createClass(ProjectSection, [
      {
        ...
        value: function handleClick(e) {
          ...
          var updatedTags = firstClick
            ? new Set([clickedTag])
            : toggleValueInSet(activeTags, clickedTag)
          var updatedShowChoose =
  ...
  ReactDOM.render(
    React.createElement(ProjectSection, { projects: projects }),
